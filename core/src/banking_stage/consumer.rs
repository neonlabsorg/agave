...
impl Consumer {
    ...
    pub fn check_fee_payer_unlocked(
        ...
        // missing or zero-lamport fee-payer can pass the banking-stage
        // pre-check; svm::validate_transaction_fee_payer synthesizes a
        // temporary system-owned fee-payer account when needed.
        if fee == 0 {
            return Ok(());
        }
