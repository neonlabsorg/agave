use {
    ...
    // NB: fork divergence — v4's transaction-view is the two-bool SIMD-406 form, so we do NOT
    // use upstream's `sanitize_config()` (that lives behind #13152/#13816, not on the v4 line).
